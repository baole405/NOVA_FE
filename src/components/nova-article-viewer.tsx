...
interface NovaArticleViewerProps {
  article: ViewerArticle;
  canEdit?: boolean;
  pageviews?: number | null;
}

export default function NovaArticleViewer({
  article,
  canEdit = false,
}: NovaArticleViewerProps) {
      ...
      <div className="flex justify-between items-start mb-6">
        ...
        {canEdit && (
          <div className="ml-4 flex items-center gap-2">
            <Link href={`/nova/edit/${article.id}`} className="cursor-pointer">
