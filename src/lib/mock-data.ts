...
export const mockCommunityPosts: CommunityPost[] = [
  {
    id: "post_001",
    title: "Ai biết thợ sửa điều hòa tốt không?",
    content:
      "Điều hòa nhà mình bị chảy nước, cần tìm thợ sửa uy tín. Bạn nào có số thợ tốt cho mình xin với, cảm ơn mọi người!",
    category: "qa",
    authorId: "user_001",
  ...
  {
    id: "post_002",
    title: "Thanh lý bàn ghế gỗ còn mới 90%",
    content:
      "Mình cần thanh lý bộ bàn ghế gỗ 4 ghế, mua được 6 tháng, còn rất mới. Giá 3 triệu (mua 7 triệu). Ai quan tâm inbox mình nhé.",
    category: "buy_sell",
    authorId: "user_002",
  ...
  {
    id: "post_003",
    title: "Lớp yoga miễn phí cho cư dân",
    content:
      "Chào mọi người! Mình là huấn luyện viên yoga, muốn tổ chức lớp yoga miễn phí cho cư dân vào mỗi sáng thứ 7 tại khu vực sảnh tầng 1. Ai muốn tham gia đăng ký ở đây nhé!",
    category: "events",
    authorId: "user_003",
  ...
  {
    id: "post_004",
    title: "Hỏi về quy trình đăng ký gửi xe ô tô",
    content:
      "Mình mới chuyển đến và muốn đăng ký gửi xe ô tô ở tầng hầm. Ai biết quy trình đăng ký như thế nào không? Cần giấy tờ gì?",
    category: "qa",
    authorId: "user_004",
  ...
  },
  {
    ...
    content:
      "Có ai muốn chạy bộ cùng không? Mình hay chạy quanh khu vực tòa nhà lúc 6h sáng. Chạy cùng cho vui và có động lực!",
    category: "general",
    authorId: "user_005",
  ...
  {
    id: "post_006",
    title: "Bán máy lọc không khí Xiaomi, mới 100%",
    content:
      "Mình được tặng máy lọc không khí Xiaomi Mi Air Purifier 4, chưa khui hộp. Bán giá 2.5 triệu (giá shop 3.5 triệu). Liên hệ mình qua SĐT.",
    category: "buy_sell",
    authorId: "user_006",
    authorName: "Vũ Thị Ngọc",
    apartmentUnit: "2510",
...
// Manager Apartments
export const mockManagerApartments: ManagerApartment[] = [
  {
    id: "apt_001",
    unitNumber: "0101",
    floor: 1,
...
// Manager Complaints
export const mockManagerComplaints: ManagerComplaint[] = [
  ...mockComplaints.map((c) => ({ ...c, responses: [] })),
  {
    id: "cpl_006",
    title: "Rò rỉ nước trần nhà tầng 12",
    category: "plumbing",
    description:
      "Trần nhà phòng khách bị thấm nước từ tầng trên, vết thấm ngày càng lớn. Đề nghị BQL kiểm tra và xử lý gấp.",
    urgency: "high",
    status: "pending",
  ...
  {
    id: "cpl_007",
    title: "Hệ thống báo cháy kêu liên tục",
    category: "electrical",
    description:
      "Đầu báo cháy trong căn hộ kêu liên tục từ đêm qua, đã thử reset nhưng không được. Rất phiền khi ngủ.",
    urgency: "high",
    status: "in_progress",
    ...
    responses: [
      {
        id: "res_001",
        complaintId: "cpl_007",
        content: "Đã tiếp nhận, kỹ thuật viên sẽ kiểm tra trong sáng nay.",
        author: "BQL - Nguyễn Văn Quản",
        createdAt: "2026-02-24T08:00:00Z",
      },
    ],
  },
  {
    id: "cpl_008",
    title: "Bãi xe tầng B2 bị ngập nước",
    category: "other",
    description:
      "Sau trận mưa lớn đêm qua, tầng B2 bãi xe bị ngập khoảng 10cm nước. Xe máy của nhiều cư dân bị ảnh hưởng.",
    urgency: "high",
    status: "in_progress",
    ...
    responses: [
      {
        ...
        complaintId: "cpl_008",
        content:
          "Đội bảo vệ đang tiến hành bơm nước ra. Dự kiến hoàn tất trong 2 giờ.",
        author: "BQL - Trần Minh Đức",
